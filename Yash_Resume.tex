...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Spearheaded a major cost-saving initiative by replacing a legacy Lambda-based caching mechanism with native Redis TTLs, enabling decommissioning of a cross-region MongoDB instance and reducing the service's codebase by 60\%}
