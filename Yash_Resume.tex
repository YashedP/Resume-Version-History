...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Backend Software Engineer Intern}{Melbourne, Florida}
    \resumeItemListStart
      \resumeItem{Engineered a distributed, scalable, event-driven data pipeline for a key client product using SQS, Lambda, and Step Functions, contributing to a launch one week ahead of schedule}
