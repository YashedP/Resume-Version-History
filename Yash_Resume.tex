  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Owned the end-to-end implementation of a new API capability, orchestrating changes across a Node.js Lambda, a DynamoDB stream-triggered Step Function, and the API Gateway via its OpenAPI specification}
        \resumeItem{Architected and developed a custom Go-based JWT authorizer for API Gateway, enforcing PKCS\#8/PKIX keys standards to secure API endpoints, and created the Java client library for seamless integration by other teams}
