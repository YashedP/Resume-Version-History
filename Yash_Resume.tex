  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Owned the end-to-end implementation of a new API capability, orchestrating changes across a Node.js Lambda, a DynamoDB stream-triggered Step Function, and modifying the API's OpenAPI (Swagger) specification}
        \resumeItem{Architected and developed a custom Go-based JWT authorizer flow using API Gateway, enforcing PKCS\#8/PKIX keys standards to secure API endpoints, and created the Java client library for seamless integration by other teams}
        ...
        \resumeItem{Proactively identified and resolved database bottlenecks by re-architecting indexes on a production RDS table, significantly improving query performance and resolving a class of recurring performance issues}
