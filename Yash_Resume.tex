  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Architected and developed a custom Go-based JWT authorizer flow using API Gateway, enforcing PKCS\#8/PKIX key standards to secure API endpoints, and created the Java client library for seamless integration by other teams}
