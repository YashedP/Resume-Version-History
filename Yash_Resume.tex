...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Engineered distributed, event-driven serverless microservices and REST APIs using SQS, Lambda, and Step Functions, contributing to a launch one week ahead of schedule}
      ...
      \resumeItem{Implemented Database Activity Monitoring (DAM) features to improve audit visibility across cloud data services}
      \resumeItem{Improved query performance by over \textbf{90\%} through RDS index tuning and DynamoDB GSI design via Terraform}
    \resumeItemListEnd
  \resumeSubheading
