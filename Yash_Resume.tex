...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Engineered a distributed, scalable, event-driven data pipeline for a key client product using SQS, Lambda, and Step Functions, creating RESTful APIs, and contributing to a launch one week ahead of schedule}
