...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{Improved query performance by over \textbf{99\%} through RDS index tuning and DynamoDB GSI design via Terraform}
    \resumeItemListEnd
  \resumeSubheading
  ...
  \vspace{-5pt}
    \resumeSubHeadingListStart
      \resumeProjectHeading
        {\textbf{Receding Coastlines} $|$ \emph{Python, Flask, GeoPandas, PyTorch, Transformer, Google Earth Engine}}{Oct 2025}
        \resumeItemListStart
      ...
      \vspace{-20pt}
      \resumeProjectHeading
        {\textbf{HelpSignal} $|$ \emph{React Native, TypeScript, Python, Flask, AWS, Cloudflare Workers}}{Oct 2024}
        \resumeItemListStart
      ...
      \vspace{-20pt}
      \resumeProjectHeading
        {\textbf{TravelAmulet} $|$ \emph{Next.js, React, TypeScript, Python, Flask, Prisma, TiDB Cloud, MySQL}}{Aug 2024}
        \resumeItemListStart
 ...
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
      \begin{comment}
        ...
        - Databricks
      \end{comment}
      \textbf{Languages}{: Go, JavaScript, TypeScript, Java, Python, SQL, C/C++} \\
