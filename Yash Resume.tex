...
\begin{center}
    ...
    \raisebox{-0.2\height}{\faLinkedin}~\href{https://www.linkedin.com/in/yash-jani-8245bb26a/}{linkedin.com/in/yash-jani-8245bb26a}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {\textbf{ALTR} $|$ \emph{AWS, JavaScript, GoLang, Node.js, Snowflake, Databricks, Express}}{May 2025 -- Present}
    ...
    \vspace{-5pt} % Decrease the spacing between projects
    \resumeSubheading
      {\textbf{FIRST Robotics Team 263, Sachem Aftershock} $|$ \emph{Java, C++}}{September 2018 -- August 2023}
